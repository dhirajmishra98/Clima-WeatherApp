            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async {
                      var cityWeatherName = await Navigator.push(context, MaterialPageRoute(builder: (context){
                        return CityScreen();
                      }));

                      if( cityWeatherName != null)  {
                        var weatherData = await weather.getCityWeather(cityWeatherName);
                        updateUI(weatherData);
                      }
                    },
                    child: Icon(
